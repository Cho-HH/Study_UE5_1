...
#include "ArenaBattle/Public/BTTaskNode_Attack.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBTTaskNode_Attack() {}
// Cross Module References
	ARENABATTLE_API UClass* Z_Construct_UClass_UBTTaskNode_Attack_NoRegister();
	ARENABATTLE_API UClass* Z_Construct_UClass_UBTTaskNode_Attack();
...
// End Cross Module References
	...
	template<> ARENABATTLE_API UClass* StaticClass<UBTTaskNode_Attack>()
	{
		return UBTTaskNode_Attack::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UBTTaskNode_Attack);
	struct Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_BTTaskNode_Attack_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_BTTaskNode_Attack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTaskNode_Attack, UBTTaskNode_Attack::StaticClass, TEXT("UBTTaskNode_Attack"), &Z_Registration_Info_UClass_UBTTaskNode_Attack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTaskNode_Attack), 288317466U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_BTTaskNode_Attack_h_832258289(TEXT("/Script/ArenaBattle"),
		Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_BTTaskNode_Attack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ArenaBattle_Source_ArenaBattle_Public_BTTaskNode_Attack_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
