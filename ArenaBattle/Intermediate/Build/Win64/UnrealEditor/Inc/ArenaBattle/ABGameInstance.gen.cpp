...
class UScriptStruct* FABCharacterData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ABCharacterData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FABCharacterData, Z_Construct_UPackage__Script_ArenaBattle(), TEXT("ABCharacterData"));
	}
...
template<> ARENABATTLE_API UScriptStruct* StaticStruct<FABCharacterData>()
{
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_mABCharacterTable_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_mABCharacterTable;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UABGameInstance_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UABGameInstance_Statics::NewProp_mABCharacterTable,
	};
